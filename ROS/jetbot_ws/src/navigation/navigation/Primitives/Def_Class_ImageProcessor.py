    ...
    def initModel(self):
        ...
        if not self.gazebo:
            ...
            self.model.load_state_dict(
                torch.load('/home/jetbot/Robotikseminar/jetbot_ws/src/navigation/navigation/utils/steering_model_angle_gpu.pth'))
            ...
            self.model.load_state_dict(
                torch.load('/home/jetbot/Robotikseminar/jetbot_ws/src/navigation/navigation/utils/squeezenet_V1_CPU.pth',
